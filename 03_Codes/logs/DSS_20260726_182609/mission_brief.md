...
MAP: 100 x 100 cells at 30 m; land cover: non fuel 7%, grass 14%, shrub 10%, pine litter 21%, hardwood 5%, water 35%, urban 8%.
- water: 3533 cells of lake/river/sea, centred near (75,57); engines and aircraft can draft/refill there, so sustained capacity near the water is real.
- assets on the map (protect by value and life):
  population 'Town residents' at (0,44), ~18543 persons, value 1.0
  building 'Town centre' at (0,44), value 1.0
  critical 'Hospital' at (4,45), value 1.0
  critical 'Power plant' at (0,51), value 0.9
  critical 'Water treatment' at (0,46), value 0.9
  critical 'Government office' at (0,41), value 0.8
  critical 'School' at (4,39), value 0.8
  population 'Village 1 residents' at (45,0), ~8133 persons, value 1.0
  building 'Village 1 centre' at (45,0), value 0.7
  critical 'Hospital (Village 1)' at (43,0), value 1.0
  critical 'Government office (Village 1)' at (50,0), value 0.8
  critical 'School (Village 1)' at (42,6), value 0.8
  population 'Village 2 residents' at (0,74), ~7863 persons, value 1.0
  building 'Village 2 centre' at (0,74), value 0.7
- resources: staged capacity 131 (rcap sum), map-mean travel time 30 min, air support: yes.
