...
MAP: 100 x 100 cells at 100 m; land cover: non fuel 12%, grass 9%, shrub 15%, pine litter 45%, hardwood 7%, urban 12%.
- water: NONE on this map. water_drafting and retardant_drop cannot be supplied here; do not order them, a rule citing them is rejected.
- assets on the map (protect by value and life):
  population 'Town residents' at (52,13), ~19277 persons, value 1.0
  building 'Town centre' at (52,13), value 1.0
  critical 'Hospital' at (51,9), value 1.0
  critical 'Power plant' at (57,8), value 0.9
  critical 'Water treatment' at (61,16), value 0.9
  critical 'Government office' at (53,17), value 0.8
  critical 'School' at (47,18), value 0.8
  critical 'Fire station' at (43,10), value 0.7
  population 'Village 1 residents' at (12,69), ~14258 persons, value 1.0
  building 'Village 1 centre' at (12,69), value 0.7
  critical 'Government office (Village 1)' at (15,71), value 0.8
  critical 'School (Village 1)' at (9,75), value 0.8
  critical 'Hospital (Village 1)' at (4,65), value 1.0
  critical 'Water treatment (Village 1)' at (14,66), value 0.9
- resources: staged capacity 4874 (rcap sum), map-mean travel time 21 min, air support: yes.
...
ACTUATOR LIBRARY (physics available beyond the doctrine; NO seed rule orders them, discovering a use is your job):
  ...
  water_drafting: engines and helicopters refill from the nearest lake, river or sea, raising sustained capacity near water. On a map without water it does nothing.  [UNAVAILABLE HERE: no water body to supply it]
  retardant_drop: aircraft coat the fuel ahead of the head fire with long-term retardant or soil, so the coated cells resist ignition even after the water in them dries. Aerial delivery: it does not need road access, but it is a finite, expensive pass and only the head sector is coated.  [UNAVAILABLE HERE: no water body to supply it]
